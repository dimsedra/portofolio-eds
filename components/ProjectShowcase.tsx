...
import { 
  ...
  Layers, ChevronRight, FileImage, Info, Terminal, CheckCircle,
  Github, Globe
} from 'lucide-react';
...
export default function ProjectShowcase() {
  ...
  return (
    <div className="space-y-32 md:space-y-48">
      {/* PROJECT 1: DIALOGUE */}
      <div id="project-dialogue" className="grid grid-cols-1 lg:grid-cols-12 gap-12 py-12 border-b border-zinc-900/60 scroll-mt-28">
        {/* Left Side: Summary */}
        <div className="lg:col-span-5 space-y-6 flex flex-col justify-between">
          <div className="space-y-4">
            ...
            <h3 className="text-3xl font-display font-medium tracking-tight text-zinc-50">
              Dialogue: Fully Local Intelligence
            </h3>
            ...
            <div className="pt-2">
              ...
              <div className="flex flex-wrap gap-1.5">
                {['Next.js', 'Pocketbase (Go/SQLite)', 'Mastra SDK', 'Vercel AI SDK', 'Tailwind'].map(t => (
      ...
      {/* PROJECT 2: EXIFSENSE */}
      <div id="project-exifsense" className="grid grid-cols-1 lg:grid-cols-12 gap-12 py-12 border-b border-zinc-900/60 scroll-mt-28">
        {/* Left Side: Summary */}
        <div className="lg:col-span-5 space-y-6 flex flex-col justify-between">
          <div className="space-y-4">
            <div className="flex items-center space-x-2.5">
            ...
            <h3 className="text-3xl font-display font-medium tracking-tight text-zinc-50">
              ExifSense: Narrative Exif Extractor
            </h3>
            ...
            <div className="pt-2">
              <span className="block text-[10px] font-mono text-zinc-500 uppercase tracking-wider mb-2">Core Stack</span>
              <div className="flex flex-wrap gap-1.5">
                {['Vanilla JS', 'HTML5/CSS3', 'i18n Engine', 'EXIF Parser'].map(t => (
                  <span key={t} className="text-[11px] font-mono bg-zinc-900 border border-zinc-800 rounded px-2 py-0.5 text-zinc-300">{t}</span>
                ))}
              </div>
            </div>
      ...
      {/* PROJECT 3: GEMSTONE */}
      <div id="project-gemstone" className="grid grid-cols-1 lg:grid-cols-12 gap-12 py-12 border-b border-zinc-900/60 scroll-mt-28">
        {/* Left Side: Summary */}
        <div className="lg:col-span-5 space-y-6 flex flex-col justify-between">
          <div className="space-y-4">
            <div className="flex items-center space-x-2.5">
            ...
            <div className="pt-2">
              <span className="block text-[10px] font-mono text-zinc-500 uppercase tracking-wider mb-2">Core Stack</span>
              <div className="flex flex-wrap gap-1.5">
                {['PyTorch', 'ResNet50', 'FastAPI', 'Roboflow', 'Pillow'].map(t => (
                  <span key={t} className="text-[11px] font-mono bg-zinc-900 border border-zinc-800 rounded px-2 py-0.5 text-zinc-300">{t}</span>
                ))}
              </div>
            </div>
      ...
      {/* PROJECT 4: SECURITY QA */}
      <div id="project-security" className="grid grid-cols-1 lg:grid-cols-12 gap-12 py-12 scroll-mt-28">
        {/* Left Side: Summary */}
        <div className="lg:col-span-5 space-y-6 flex flex-col justify-between">
          <div className="space-y-4">
            <div className="flex items-center space-x-2.5">
            ...
            <h3 className="text-3xl font-display font-medium tracking-tight text-zinc-50">
              Architecting Zero-Trust Platforms
            </h3>
            ...
            <div className="pt-2">
              <span className="block text-[10px] font-mono text-zinc-500 uppercase tracking-wider mb-2">Core Stack</span>
              <div className="flex flex-wrap gap-1.5">
                {['OWASP ZAP', 'Agile/Sprints', 'Parallel Testing', 'Secure SDLC', 'DOM Threat Auditing'].map(t => (
                  <span key={t} className="text-[11px] font-mono bg-zinc-900 border border-zinc-800 rounded px-2 py-0.5 text-zinc-300">{t}</span>
                ))}
              </div>
            </div>
